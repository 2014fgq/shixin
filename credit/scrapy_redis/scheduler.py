...
class Scheduler(object):
    ...
    def __init__(self, server, persist, queue_key, queue_cls, dupefilter_key, crawler):
    ...
    def from_settings(cls, settings, crawler):
        ...
        return cls(server, persist, queue_key, queue_cls, dupefilter_key, crawler)
    ...
    def from_crawler(cls, crawler):
        ...
        return cls.from_settings(settings, crawler)
